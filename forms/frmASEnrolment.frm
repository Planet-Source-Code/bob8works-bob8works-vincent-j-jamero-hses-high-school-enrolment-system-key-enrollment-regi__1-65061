...
Begin VB.Form frmASEnrolment 
   ...
   Begin HSES.b8SContainer b8SContainer1 
      ...
      Begin VB.CommandButton cmdRemoveAll 
         ...
         Height          =   330
         Left            =   7140
         Picture         =   "frmASEnrolment.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   60
         Width           =   525
      ...
      Begin VB.CommandButton cmdRemoveOne 
         ...
         Height          =   330
         Left            =   6600
         Picture         =   "frmASEnrolment.frx":0E54
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   60
         Width           =   525
   ...
   Begin VB.CommandButton cmdAddOne 
      ...
      Height          =   420
      Left            =   6780
      Picture         =   "frmASEnrolment.frx":13DE
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   2640
      Width           =   1005
   ...
   Begin VB.Label Label3 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Filter Enrolment Entries"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   14.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   525
      Left            =   0
      Picture         =   "frmASEnrolment.frx":1968
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8925
   End
End
Attribute VB_Name = "frmASEnrolment"
...
Private Function RefreshCriteriaByField()
    ...
    Select Case LCase(cmbFields.Text)
        ...
        Case "student's sender"
            cmbCriteria.Clear
            cmbCriteria.AddItem "Male"
            cmbCriteria.AddItem "Female"
            cmbCriteria.ListIndex = 0
        
        Case "student's status"
            cmbCriteria.Clear
            cmbCriteria.AddItem "Single"
            cmbCriteria.AddItem "Married"
            cmbCriteria.AddItem "Separated"
            cmbCriteria.AddItem "Widowed"
            cmbCriteria.ListIndex = 0
...
Private Sub cmdAddOne_Click()
    ...
    If iSSUbound >= 99 Then
        MsgBox "Criteria limit reached.", vbExclamation
        Exit Sub
    End If
...
Private Sub cmdOK_Click()
    ...
    frmAllEnrolment.ShowFormList , , , , sSQL
...
Private Function RefreshFieldList()
    ...
    sCS(li) = "School Year"
    sFT(li) = "s"
    sFL(li) = "tblEnrolment.SchoolYear"
    li = li + 1
    ...
    sCS(li) = "Adviser First Name"
    sFT(li) = "s"
    sFL(li) = "tblTeacher.FirstName"
    li = li + 1
    
    sCS(li) = "Adviser Middle Name"
    sFT(li) = "s"
    sFL(li) = "tblTeacher.MiddleName"
    li = li + 1
    
    sCS(li) = "Adviser Last Name"
    sFT(li) = "s"
    sFL(li) = "tblTeacher.LastName"
    li = li + 1
    ...
    sCS(li) = "Student's ID"
    sFT(li) = "s"
    sFL(li) = "tblStudent.StudentID"
    li = li + 1
    
    sCS(li) = "Student's First Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.FirstName"
    li = li + 1
    
    sCS(li) = "Student's Middle Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.MiddleName"
    li = li + 1
    
    sCS(li) = "Student's Last Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.LastName"
    li = li + 1
    
    sCS(li) = "Student's Gender"
    sFT(li) = "s"
    sFL(li) = "tblStudent.Gender"
    li = li + 1
    
    '----------------------------------
    
    sCS(li) = "Student's Status"
    sFT(li) = "s"
    sFL(li) = "tblStudent.Status"
    li = li + 1
    
    sCS(li) = "Student's Citizenship"
    sFT(li) = "s"
    sFL(li) = "tblStudent.Citizenship"
    li = li + 1
    
    sCS(li) = "Student's Birth Date"
    sFT(li) = "d"
    sFL(li) = "tblStudent.BirthDate"
    li = li + 1
    
    sCS(li) = "Student's Place of Birth"
    sFT(li) = "s"
    sFL(li) = "tblStudent.PlaceOfBirth"
    li = li + 1
    
    sCS(li) = "Student's Home Address"
    sFT(li) = "s"
    sFL(li) = "tblStudent.HomeAddress"
    li = li + 1
    
    sCS(li) = "Student's City Address"
    sFT(li) = "s"
    sFL(li) = "tblStudent.CityAddress"
    li = li + 1
    
    sCS(li) = "Student's Blood Type"
    sFT(li) = "s"
    sFL(li) = "tblStudent.BloodType"
    li = li + 1
    
    sCS(li) = "Student's Religion"
    sFT(li) = "s"
    sFL(li) = "tblStudent.Religion"
    li = li + 1
    
    sCS(li) = "Student's Last School Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.LastSchoolName"
    li = li + 1
    
    sCS(li) = "Student's Last School Contact Number"
    sFT(li) = "s"
    sFL(li) = "tblStudent.LastSchoolContactNumber"
    li = li + 1
    
    sCS(li) = "Student's Last School Address"
    sFT(li) = "s"
    sFL(li) = "tblStudent.LastSchoolContactAddress"
    li = li + 1
    
    sCS(li) = "Student's Mother Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.MotherName"
    li = li + 1
    
    sCS(li) = "Student's Mother Occupation"
    sFT(li) = "s"
    sFL(li) = "tblStudent.MotherOccupation"
    li = li + 1
    
    sCS(li) = "Student's Father Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.FatherName"
    li = li + 1
    
    sCS(li) = "Student's Father Occupation"
    sFT(li) = "s"
    sFL(li) = "tblStudent.FatherOccupation"
    li = li + 1
    
    sCS(li) = "Student's Parent Contact Number"
    sFT(li) = "s"
    sFL(li) = "tblStudent.ParentContactNumber"
    li = li + 1
    
    sCS(li) = "Student's Guardian Name"
    sFT(li) = "s"
    sFL(li) = "tblStudent.GuardianName"
    li = li + 1
    
    sCS(li) = "Student's Guardian Contact Number"
    sFT(li) = "s"
    sFL(li) = "tblStudent.GuardianContactNumber"
    li = li + 1
    
    sCS(li) = "Student's Guardian Address"
    sFT(li) = "s"
    sFL(li) = "tblStudent.GuardianAddress"
    li = li + 1
    
    sCS(li) = "Student's Creation Date"
    sFT(li) = "d"
    sFL(li) = "tblStudent.CreationDate"
    li = li + 1
