...
Begin VB.Form frmRESchoolYear 
   ...
   Begin MSComctlLib.ImageList imgListIco32 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRESchoolYear.frx":058A
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox bgInfo 
      ...
      Begin lvButton.lvButtons_H cmdShowEnrolmentList 
         ...
         _ExtentX        =   4657
         _ExtentY        =   688
         Caption         =   "View All Enrolment Entries"
         CapAlign        =   2
         BackStyle       =   5
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRESchoolYear.frx":0E64
         cBack           =   16185592
      End
      Begin lvButton.lvButtons_H cmdPrintAllEnrolment 
         Height          =   390
         Left            =   675
         TabIndex        =   5
         Top             =   855
         ...
         _ExtentX        =   4657
         _ExtentY        =   688
         Caption         =   "Print All Enrolment Entries"
         CapAlign        =   2
         BackStyle       =   5
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmRESchoolYear.frx":13FE
         cBack           =   16185592
      End
   ...
   Begin MSComctlLib.ImageList imgListIco16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmRESchoolYear.frx":1998
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmRESchoolYear"
...
Public Sub ShowForm(sKey() As String, sText() As String)
    Dim i As Integer
