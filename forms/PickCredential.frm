...
Begin VB.Form PickCredential 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSComctlLib.ImageList ilRecordIco 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "PickCredential.frx":0000
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ListView listRecord 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         MouseIcon       =   "PickCredential.frx":059A
         NumItems        =   2
      ...
      Begin VB.Image Image4 
         Height          =   75
         Left            =   0
         Picture         =   "PickCredential.frx":140E
         Stretch         =   -1  'True
         Top             =   0
         Width           =   5565
      End
      ...
      Begin VB.Image Image1 
         Height          =   435
         Left            =   0
         Picture         =   "PickCredential.frx":14AB
         Stretch         =   -1  'True
         Top             =   345
         Width           =   5505
      End
   End
End
Attribute VB_Name = "PickCredential"
...
Dim tmpCredentialID As String
Dim vRS As New ADODB.Recordset

Dim MaxEntryCount As Long
Dim CurRecPos As Long
Dim CurCredentialCount As Long
...
Public Function GetCredentialID(Optional ByRef TextObject As Object, Optional lMaxEntryCount As Long = 15, Optional ByRef sTitle As String) As String
    ...
    sSQL = "Select tblCredential.CredentialID as lvKey, tblCredential.CredentialID, tblCredential.Title From tblCredential ORDER BY tblCredential.Title"
    ...
    If ConnectRS(HSESDB, vRS, sSQL) = True Then
        ...
        If CurCredentialCount > 0 Then
            FillList CurRecPos, MaxEntryCount

        Else
            'error
            MsgBox "No Credential to be selected." & vbNewLine & "Please Add New Credential first.", vbExclamation
            Unload Me
            Exit Function
        End If
    Else
...
ConShowForm:
    ...
    GetCredentialID = tmpCredentialID
    sTitle = curTitle
    
End Function


Private Sub ReturnGetCredentialID()
    If Len(GetLVKey(listRecord.SelectedItem)) > 0 Then
        tmpCredentialID = GetLVKey(listRecord.SelectedItem)
        curTitle = listRecord.SelectedItem.SubItems(1)
        Unload Me
    End If
End Sub
Private Sub CancelGetCredentialID()
    tmpCredentialID = ""
    Unload Me
End Sub
...
Private Sub b8navRecordRefresh()
    CurCredentialCount = getRecordCount(vRS)
    ...
    If CurRecPos < CurCredentialCount - MaxEntryCount Then
...
Private Sub cmdCancel_Click()
    CancelGetCredentialID
End Sub

Private Sub cmdFind_Click()
    Dim sSQL As String
    
    sSQL = "Select tblCredential.CredentialID as lvKey, tblCredential.CredentialID, tblCredential.Title" & _
            " From tblCredential " & _
            " WHERE tblCredential.Title like '%" & txtFind.Text & "%' OR tblCredential.CredentialID like '%" & txtFind.Text & "%'" & _
    ...
    If ConnectRS(HSESDB, vRS, sSQL) = True Then
        ...
        End If
    Else
        MsgBox "FATAL ERROR: PickCredential.cmdFind_Click - Connectrs"
    End If
...
Private Sub listRecord_Click()
    ...
    Else
        lblListInfo.Caption = "Selected Entry: " & listRecord.SelectedItem.Index + CurRecPos & "/" & CurCredentialCount
        
        totalPage = CurCredentialCount \ MaxEntryCount + 1
...
Private Function FillList(lStart As Long, dCount As Long) As Boolean
    ...
    FillRecordToList vRS, listRecord, "cred", lStart, dCount, , True
    listRecord_Click
End Function
...
Private Sub listRecord_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyReturn Then ReturnGetCredentialID
