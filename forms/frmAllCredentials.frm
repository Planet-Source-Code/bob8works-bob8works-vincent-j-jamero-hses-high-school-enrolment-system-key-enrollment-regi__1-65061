...
Begin VB.Form frmAllCredentials 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Credentials"
   ClientHeight    =   6360
   ClientLeft      =   60
   ...
   ClientWidth     =   7560
   ControlBox      =   0   'False
   Icon            =   "frmAllCredentials.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   424
   ScaleMode       =   3  'Pixel
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllCredentials.frx":0ECA
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllCredentials.frx":1464
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin MSComctlLib.ImageList ilRecordIco 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   1
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllCredentials.frx":19FE
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmAllCredentials"
...
Public Sub ShowFormList(Optional iMaxEntryCount As Long = 21, Optional iCurRecPos As Long = 0)
    ...
    'connect rs
    sDefaultSQL = "SELECT tblCredential.CredentialID, tblCredential.Title, tblCredential.Description, tblCredential.CreationDate, tblCredential.CreatedBy" & _
                    " From tblCredential"
                    
    
    If ConnectRS(HSESDB, vRS, sDefaultSQL & " ORDER BY tblCredential.Title") Then
        b8navRecordRefresh
        Form_SetFieldList
        FillList vRS
    ...
    Else
        MsgBox "Unable to show Credential List.", vbCritical
        Unload Me
    End If
...
Public Sub Form_Add()
    'show add
    If frmCredential.ShowAdd Then Form_Refresh
End Sub
Public Sub Form_Edit()
    ...
    'show edit
    If frmCredential.ShowEdit(GetLVKey(listRecord.SelectedItem)) = True Then
        Form_Refresh
    End If
End Sub
...
Public Function Form_Filter(sFindWhat As String, sFieldName As String)
    ...
    If Form_OrigFields(FIndex) = sAllFields Then
        ...
        sSQL = sSQL & " ORDER BY tblCredential.Title;"
    ...
    Else
        ...
        If ConnectRS(HSESDB, vRS, sDefaultSQL & " ORDER BY tblCredential.Title") = False Then
            'temp
            'fatal
            MsgBox "FATAL ERROR: frmAllStudent.Form_filter - Connecting Default StudentRecordset.", vbExclamation
            'close this form
...
Public Function Form_Description() As String
    Form_Description = "Display Credential entries"
End Function
