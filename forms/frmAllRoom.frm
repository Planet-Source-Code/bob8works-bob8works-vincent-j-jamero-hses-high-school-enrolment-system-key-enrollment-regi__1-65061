      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllRoom.frx":0ECA
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllRoom.frx":1464
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Public Sub ShowFormList(Optional iMaxEntryCount As Long = 21, Optional iCurRecPos As Long = 0)
    ...
    'connect rs
    sDefaultSQL = "SELECT tblRoom.RoomID, tblRoom.Room, tblRoom.Description" & _
                    " From tblRoom"

    
    If ConnectRS(HSESDB, vRS, sDefaultSQL & " ORDER BY tblRoom.Room") Then
        b8navRecordRefresh
        Form_SetFieldList
        FillList vRS
...
Public Sub Form_Add()
    'show add
    If frmAddRoom.ShowForm Then Form_Refresh
End Sub
Public Sub Form_Edit()
    ...
    'show edit
    If frmEditRoom.ShowEdit(GetLVKey(listRecord.SelectedItem)) = True Then
        Form_Refresh
    End If
End Sub
