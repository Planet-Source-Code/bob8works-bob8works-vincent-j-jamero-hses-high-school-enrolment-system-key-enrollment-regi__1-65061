...
Begin VB.Form PickSchoolYear 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin HSES.b8TitleBar b8TitleBar1 
         ...
         FontName        =   "Tahoma"
         FontSize        =   8.25
         Icon            =   "frmSchoolYearPicker.frx":0000
      End
      Begin HSES.b8Container b8Container1 
         ...
         Begin MSComctlLib.ListView listRecord 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "frmSchoolYearPicker.frx":059A
            NumItems        =   1
      ...
      Begin VB.Image Image4 
         Height          =   75
         Left            =   0
         Picture         =   "frmSchoolYearPicker.frx":0E74
         Stretch         =   -1  'True
         Top             =   0
         Width           =   5565
      End
      ...
      Begin VB.Image Image1 
         Height          =   435
         Left            =   0
         Picture         =   "frmSchoolYearPicker.frx":0F11
         Stretch         =   -1  'True
         Top             =   345
         Width           =   5505
      End
   ...
   Begin MSComctlLib.ImageList ilRecordIco 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSchoolYearPicker.frx":0FAE
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSchoolYearPicker.frx":1548
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSchoolYearPicker.frx":1AE2
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSchoolYearPicker.frx":207C
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "PickSchoolYear"
...
Public Function GetItem(Optional TextObject As Variant, Optional lMaxEntryCount As Long = 15, Optional OldSchoolYear As String = "0000", Optional ExcludeClosed As Boolean = False) As String
    ...
    sSQL = "SELECT tblSchoolYear.SchoolYearTitle AS lvKey, tblSchoolYear.SchoolYearTitle" & _
            ...
            " WHERE (((Val(Left([SchoolYearTitle],4)))>" & Left(sOldSchoolYear, 4) & ")) " & sWC
