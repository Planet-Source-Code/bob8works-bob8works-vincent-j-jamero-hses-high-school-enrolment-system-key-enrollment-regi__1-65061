...
Begin VB.Form frmAllDropped 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Dropped Students"
   ClientHeight    =   6360
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7560
   ControlBox      =   0   'False
   Icon            =   "frmAllDropped.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   424
   ScaleMode       =   3  'Pixel
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllDropped.frx":0ECA
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllDropped.frx":1464
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HSES.b8ChildTitleBar b8Title 
         ...
         _ExtentY        =   609
         BackColor       =   16777215
         Caption         =   "Manage Dropped Students"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
      ...
      Begin MSComctlLib.ImageList ilRecordIco 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   1
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllDropped.frx":19FE
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmAllDropped"
...
Public Sub ShowFormList(Optional iMaxEntryCount As Long = 19, Optional iCurRecPos As Long = 0)
    ...
    'set default SQL
    sDefaultSQL = "SELECT tblDropped.SchoolYear, tblDepartment.DepartmentTitle, tblSection.SectionTitle, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName] AS StudentFullName, tblDropped.DateDropped, tblDropped.Note" & _
                    " FROM tblDropped INNER JOIN (tblDepartment INNER JOIN ((tblSection INNER JOIN tblSectionOffering ON tblSection.SectionID = tblSectionOffering.SectionID) INNER JOIN (tblStudent INNER JOIN tblEnrolment ON tblStudent.StudentID = tblEnrolment.StudentID) ON tblSectionOffering.SectionOfferingID = tblEnrolment.SectionOfferingID) ON tblDepartment.DepartmentID = tblSection.DepartmentID) ON tblDropped.StudentID = tblStudent.StudentID" & _
                    " GROUP BY tblDropped.SchoolYear, tblDepartment.DepartmentTitle, tblSection.SectionTitle, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName], tblDropped.DateDropped, tblDropped.Note" & _
                    " ORDER BY tblDropped.SchoolYear DESC;"
        
    'set SQL
    sSQL = "SELECT tblDropped.SchoolYear, tblDepartment.DepartmentTitle, tblSection.SectionTitle, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName] AS StudentFullName, tblDropped.DateDropped, tblDropped.Note" & _
                    " FROM tblDropped INNER JOIN (tblDepartment INNER JOIN ((tblSection INNER JOIN tblSectionOffering ON tblSection.SectionID = tblSectionOffering.SectionID) INNER JOIN (tblStudent INNER JOIN tblEnrolment ON tblStudent.StudentID = tblEnrolment.StudentID) ON tblSectionOffering.SectionOfferingID = tblEnrolment.SectionOfferingID) ON tblDepartment.DepartmentID = tblSection.DepartmentID) ON tblDropped.StudentID = tblStudent.StudentID" & _
                    " GROUP BY tblDropped.SchoolYear, tblDepartment.DepartmentTitle, tblSection.SectionTitle, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName], tblDropped.DateDropped, tblDropped.Note" & _
                    " ORDER BY tblDropped.SchoolYear DESC;"
...
Public Function Form_Add()
    If frmAddDropped.ShowForm = True Then
        Form_Reload
    End If
End Function
...
Public Sub Form_Delete()
    If Len(listRecord.SelectedItem.Text) > 0 Then
        If frmDeleteDropped.ShowForm(GetLVKey(listRecord.SelectedItem)) = True Then
            Form_Reload
        End If
    Else
...
Public Function Form_Filter(sFindWhat As String, sFieldName As String)
    ...
    If Form_OrigFields(FIndex) = sAllFields Then
        ...
        sSQL = "SELECT tblStudent.StudentID AS lvKey, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName] AS StudentFullName, tblDropped.SchoolYear, tblDropped.DateDropped" & _
        ...
        sSQL = sSQL & " GROUP BY tblStudent.StudentID, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName], tblDropped.SchoolYear, tblDropped.DateDropped" & _
    ...
    Else
        ...
        sSQL = "SELECT tblStudent.StudentID AS lvKey, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName] AS StudentFullName, tblDropped.SchoolYear, tblDropped.DateDropped" & _
                ...
                " GROUP BY tblStudent.StudentID, [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName], tblDropped.SchoolYear, tblDropped.DateDropped" & _
                " ORDER BY [tblStudent].[LastName] & ', ' & [tblStudent].[FirstName] & ' ' & [tblStudent].[MiddleName]"
...
Private Function Form_SetFieldList()
    ...
    Form_Fields(1) = "Student Full Name"
...
Public Function Form_Print()
    ...
    Set drDropped.DataSource = vRS
    
        drDropped.Show vbModal
