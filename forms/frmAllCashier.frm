...
Begin VB.Form frmAllCashier 
   ...
   End
End
Attribute VB_Name = "frmAllCashier"
...
Public Sub ShowFormList()
    ...
    sDefaultSQL = "SELECT tblCashier.CashierID, tblCashier.LoginName, tblCashier.FirstName, tblCashier.MiddleName, tblCashier.LastName, tblCashier.ContactNumber, tblCashier.Address, tblCashier.CreationDate, tblCashier.CreatedBy" & _
                " From tblCashier"

    sSQL = "SELECT tblCashier.CashierID, tblCashier.LoginName, tblCashier.FirstName, tblCashier.MiddleName, tblCashier.LastName, tblCashier.ContactNumber, tblCashier.Address, tblCashier.CreationDate, tblCashier.CreatedBy" & _
            " From tblCashier"
...
Public Sub Form_Reload()
    ...
    sSQL = sDefaultSQL & " ORDER BY tblCashier.LastName"
    If ConnectRS(HSESDB, vRS, sSQL) = False Then
            'temp
            'fatal
            MsgBox "FATAL ERROR: frmAllCashier.Form_filter - Connecting Default StudentRecordset.", vbExclamation
            'close this form
            Unload Me
            Exit Sub
    End If
    ...
    Else
        ...
        sSQL = "SELECT tblCashier.CashierID, tblCashier.LoginName, tblCashier.FirstName, tblCashier.MiddleName, tblCashier.LastName, tblCashier.ContactNumber, tblCashier.Address, tblCashier.CreationDate, tblCashier.CreatedBy" & _
            " From tblCashier" & _
                ...
                " ORDER BY tblCashier.MiddleName"
    End If
