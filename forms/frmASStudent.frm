...
Begin VB.Form frmASStudent 
   ...
   Begin VB.Label Label3 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Filter Student Entries"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   14.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   525
      Left            =   0
      Picture         =   "frmASStudent.frx":1968
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8925
   End
End
Attribute VB_Name = "frmASStudent"
...
Private Sub cmdOK_Click()
    ...
    frmAllStudent.ShowFormList , , sSQL
