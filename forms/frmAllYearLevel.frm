...
Begin VB.Form frmAllYearLevel 
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllYearLevel.frx":0ECA
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllYearLevel.frx":1464
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HSES.b8SContainer pbBGButton 
         ...
         Begin lvButton.lvButtons_H cmdViewSection 
            Height          =   525
            Left            =   60
            TabIndex        =   9
            Top             =   60
      ...
      Begin MSComctlLib.ImageList ilRecordIco 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   1
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllYearLevel.frx":19FE
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmAllYearLevel"
...
Public Sub ShowFormList(Optional iMaxEntryCount As Long = 21, Optional iCurRecPos As Long = 0)
    ...
    'default
    sDefaultSQL = "SELECT tblYearLevel.YearLevelID AS lvKey, tblYearLevel.YearLevelTitle FROM tblYearLevel"
    
    sSQL = "SELECT tblYearLevel.YearLevelID AS lvKey, tblYearLevel.YearLevelTitle FROM tblYearLevel"
    ...
    Else
        MsgBox "Unable to display Year Level list.", vbCritical
        Unload Me
    End If
...
Public Sub Form_Delete()
    ...
    If iSelectedCount = 1 Then
        sMSG = "WARNING:" & vbNewLine & "You are about to delete 1 YearLevel Entry and you cannot Undo this operation." & vbNewLine & _
        " Are you sure to delete it?"
    Else
        sMSG = "WARNING:" & vbNewLine & "You are about to delete " & iSelectedCount & " YearLevel Entries and you cannot Undo this operation." & vbNewLine & _
        " Are you sure to delete it?"
    End If
    ...
    If MsgBox(sMSG, vbQuestion + vbYesNo) = vbYes Then
        ...
        For i = 1 To listRecord.ListItems.Count
            ...
            If listRecord.ListItems(i).Selected = True And Len(sLVItemKey) > 0 Then
                ...
                If DeleteYearLevel(Val(sLVItemKey)) = Success Then
                    EntryDeletedCount = EntryDeletedCount + 1
                Else
                    'temp
                    'fatal
                    MsgBox "Unable to delete YearLevel Entry with ID: " & sLVItemKey
                End If
            End If
...
Private Sub cmdShowSection_Click()
    ...
    If Len(lvKey) > 0 Then
        frmAllSection.ShowFormList , Val(lvKey)
    Else
        MsgBox "Please select Year Level", vbExclamation
    End If
End Sub
...
Private Sub cmdViewSection_Click()
    Dim lvKey As String
...
Public Function Form_Filter(sFindWhat As String, sFieldName As String)
    ...
    If Form_OrigFields(FIndex) = sAllFields Then
        ...
        sSQL = sSQL & " ORDER BY YearLevelTitle;"
...
Public Function Form_Description() As String
    Form_Description = "Display All Year Levels"
End Function
Public Function Form_Tip() As String
    
    Form_Tip = "Double click entry to view all Sections under selected Year Level."
End Function


'Record Operations
Public Function Form_CanAddEntry() As Boolean
    Form_CanAddEntry = False
End Function
