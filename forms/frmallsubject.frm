   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmallsubject.frx":0ECA
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmallsubject.frx":1464
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin MSComctlLib.ImageList ilRecordIco 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   1
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmallsubject.frx":19FE
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Public Sub ShowFormList(Optional iMaxEntryCount As Long = 21, Optional iCurRecPos As Long = 0)
    ...
    'connect rs
    sDefaultSQL = "SELECT tblSubject.SubjectID AS lvKey, tblSubject.SubjectTitle AS Title, tblDepartment.DepartmentTitle AS Department, tblYearLevel.YearLevelTitle AS [Year Level], tblSubject.Description" & _
                    " FROM tblYearLevel INNER JOIN (tblDepartment INNER JOIN tblSubject ON tblDepartment.DepartmentID = tblSubject.DepartmentID) ON tblYearLevel.YearLevelID = tblSubject.YearLevelID"
...
Public Sub Form_Add()
    'show add
    If frmAddSubject.ShowForm Then Form_Refresh
End Sub
Public Sub Form_Edit()
    ...
    'show edit
    If frmEditSubject.ShowEdit(GetLVKey(listRecord.SelectedItem)) = True Then
        Form_Refresh
    End If
End Sub
...
Public Function Form_Filter(sFindWhat As String, sFieldName As String)
    ...
    If Form_OrigFields(FIndex) = sAllFields Then
        ...
        sSQL = sSQL & " ORDER BY SubjectTitle;"
