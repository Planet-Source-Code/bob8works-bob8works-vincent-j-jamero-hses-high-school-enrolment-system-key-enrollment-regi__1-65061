...
Public Function CreateDefaultRSSection(ByRef vRS As ADODB.Recordset) As TranDBResult
    ...
    If ConnectRS(HSESDB, vRS, "SELECT * FROM tblSection") Then
...
Public Function EditSection(newSection As tSection) As TranDBResult
    ...
    If ConnectRS(HSESDB, vRS, "SELECT * From tblSection WHERE (((tblSection.SectionID)='" & newSection.SectionID & "'));") Then
...
Public Function DeleteSection(sSectionID As String) As TranDBResult
    ...
    If ConnectRS(HSESDB, vRS, "Delete * From tblSection WHERE (((tblSection.SectionID)='" & sSectionID & "'));") Then
...
Public Function GetSectionByID(sSectionID As String, ByRef vSection As tSection) As TranDBResult
    ...
    If ConnectRS(HSESDB, vRS, "SELECT * From tblSection WHERE (((tblSection.SectionID)='" & sSectionID & "'));") Then
        If AnyRecordExisted(vRS) Then
            'SUCCESS: Record exist
            'get values
            '----------------------------------------------------------------

            vSection.SectionID = ReadField(vRS.Fields("sectionid"))
            vSection.SectionTitle = ReadField(vRS.Fields("Sectiontitle"))
            vSection.DepartmentID = ReadField(vRS.Fields("departmentid"))
            vSection.YearLevelID = ReadField(vRS.Fields("yearlevelid"))
            
            vSection.CreationDate = ReadField(vRS.Fields("CreationDate"))
            vSection.CreatedBy = ReadField(vRS.Fields("CreatedBy"))
            vSection.ModifiedDate = ReadField(vRS.Fields("ModifiedDate"))
            vSection.ModifiedBy = ReadField(vRS.Fields("ModifiedBy"))
...
Public Function GetSectionBySectionOfferingID(sSectionOfferingID As String, ByRef vSection As tSection) As TranDBResult
    ...
    sSQL = "SELECT tblSection.SectionID, tblSection.SectionTitle, tblSection.DepartmentID, tblSection.YearLevelID, tblSection.CreationDate, tblSection.CreatedBy, tblSection.ModifiedDate, tblSection.ModifiedBy" & _
            " FROM tblSection INNER JOIN tblSectionOffering ON tblSection.SectionID = tblSectionOffering.SectionID" & _
...
Public Function GetSectionByTitle(sSectionTitle As String, ByRef vSection As tSection) As TranDBResult
    ...
    If ConnectRS(HSESDB, vRS, "SELECT *  FROM tblSection WHERE (((tblSection.SectionTitle)='" & sSectionTitle & "'));") Then
