VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drStudentList 
   Bindings        =   "drStudentList.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   6015
   ClientLeft      =   60
   ClientTop       =   450
   ...
   EndProperty
End
Attribute VB_Name = "drStudentList"
...
Private Sub DataReport_Initialize()
    Me.Sections("Section4").Controls("lblDate").Caption = MonthName(Month(Now)) & " " & Day(Now) & ", " & Year(Now)
    Me.Sections("Section4").Controls("lblSchoolName").Caption = CurrentSchool.SchoolName
    Me.Sections("Section4").Controls("lblAddress").Caption = CurrentSchool.Address
