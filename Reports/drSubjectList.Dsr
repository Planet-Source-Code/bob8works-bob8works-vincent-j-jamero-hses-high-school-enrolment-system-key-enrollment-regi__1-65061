VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drSubjectList 
   Caption         =   "Print - Subject List"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10545
   Icon            =   "drSubjectList.dsx":0000
   ...
   EndProperty
End
Attribute VB_Name = "drSubjectList"
